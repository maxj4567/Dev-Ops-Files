...
main = {
    ...
    automaticFires = {
        ...
        locations = {
            ["city"] = {
                ...
                { coords = vector3(94.01, -1975.87, 19.61), description = "Car" },
                { coords = vector3(-1149.11, -1999.84, 12.18), description = "Car Repair" },
                { coords = vector3(-821.33, -1073.0, 10.33), description = "Clothing Shop" },
                { coords = vector3(-603.48, -926.31, 22.87), description = "Weazel New" },
                { coords = vector3(-1077.74, -242.57, 36.76), description = "LifeInvader" },
                { coords = vector3(39.09, -625.93, 30.63), description = "Construction Zone" },
                { coords = vector3(156.09, -906.75, 28.82), description = "Bin" },
                { coords = vector3(264.11, -341.45, 44.02), description = "Trees" },
                { coords = vector3(251.16, -49.64, 68.94), description = "Ammunation" },
                { coords = vector3(314.85, 191.96, 103.06), description = "Theatre" },
                { coords = vector3(-456.21, -352.12, 33.48), description = "Medical Center" },
                { coords = vector3(-829.64, -106.33, 27.19), description = "Subway" },
                { coords = vector3(-56.08, -1098.38, 25.43), description = "Cardealer" },
                { coords = vector3(434.95, -641.97, 27.73), description = "Bus station" },
                { coords = vector3(-51.1, -1663.23, 28.28), description = "Bin" },
                { coords = vector3(-214.2, -1031.94, 29.14), description = "Subway" },
                { coords = vector3(931.0, 37.32, 80.1), description = "Casino" },
                { coords = vector3(903.31, -172.14, 73.07), description = "Taxi Station" },
                { coords = vector3(826.69, -1026.24, 25.61), description = "Tank Station" },
                { coords = vector3(489.74, -1320.82, 28.17), description = "Impound" },
                { coords = vector3(339.91, -1401.18, 31.51), description = "Medical Center" },
                { coords = vector3(163.29, -1477.54, 28.14), description = "Bin" },
            },
            ["sandy"] = {
        ...
        main = {
            ...
            startFiresWithLessThanMinimum = false, -- This determines whether fires should start below the minimum number of players per fire below
    ...
    -- You must add your webhook in sv_smartfires.lua
    logging = {
        enabled = true,
