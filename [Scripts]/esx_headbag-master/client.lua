...
function OpenBagMenu() --This function is menu function
    ...
    local elements = {
          {label = 'Put bag on head', value = 'headbag-on'},
          {label = 'Remove bag from head', value = 'headbag-off'},
        ...
        elements = elements
            ...
            function(data2, menu2)
              ...
              if distance ~= -1 and distance <= 2.0 then
                ...
                if data2.current.value == 'headbag-on' then
                    NajblizszyGracz()
                end
  
                if data2.current.value == 'headbag-off' then
