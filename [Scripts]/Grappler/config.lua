...
vehicles = {
    [`FHP1`] = { -- These are examples, please edit these and add your own vehicles
        name = "FHP1",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
...
-- Uses: /grappler install, /grappler deploy, /grappler remove, /grappler reset
grapplerCommand = {
    enabled = true,
...
translations = {
    ...
    grapplerCommandParameterOneHelp = "install/deploy/remove",
