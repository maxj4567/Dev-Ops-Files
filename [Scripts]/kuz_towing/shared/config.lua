...
Locale.press_to_attach = 'Klik hier om vast te maken'
Locale.press_to_detach = 'Sleepkabel losmaken'
Locale.vehicles_locked = 'Dit voertuig is op slot en kan daarom niet getakeld worden / dief!'
